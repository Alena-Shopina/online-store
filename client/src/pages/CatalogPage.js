...
import lamp3 from "../assets/img/Lamp_3.jpg"
import lamp4 from "../assets/img/Lamp_4.webp";
...
const CatalogPage = () => {
  const allProducts = [
    ...
    { id: 5, name: "RGB lamp 5", price: 2200, img: lamp1 },
    { id: 6, name: "RGB lamp 6", price: 2700, img: lamp1 },
    { id: 7, name: "RGB lamp 7", price: 2500, img: lamp1 },
    { id: 8, name: "RGB lamp 8", price: 2200, img: lamp1 },
    { id: 9, name: "RGB lamp 9", price: 2700, img: lamp1 },
    { id: 10, name: "RGB lamp 10", price: 1500, img: lamp1 },
    { id: 11, name: "RGB lamp 11", price: 2200, img: lamp1 },
    { id: 12, name: "RGB lamp 12", price: 2700, img: lamp1 },
  ];
